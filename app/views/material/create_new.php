<section class="content">
        <div class="row clearfix">
                ...
                <form action="<?= BASEURL; ?>/material/save" method="POST" enctype="multipart/form-data">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?= $data['menu']; ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="basic_data_view">
                                    <div class="row clearfix">
                                            ...
                                            <div class="col-lg-6 col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="brand" id="brand" class="form-control" placeholder="Brand" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="supplier" id="supplier" class="form-control" placeholder="Supplier" autocomplete="off" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class="col-lg-6 col-sm-12">
                                            ...
                                            <div class="col-lg-6 col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="stdprice" id="stdprice" class="form-control" placeholder="Standard Price" required="true" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <img id="blah" src="#" alt="your image" style="width: 350px; height: 50%;"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
