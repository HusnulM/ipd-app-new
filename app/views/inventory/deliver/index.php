                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="date" name="deliverdate" id="deliverdate" class="datepicker form-control" value="<?= date('Y-m-d'); ?>">
                                        </div>
                                    </div>    
                                </div>     
                            </div>
        ...
        $(function(){
            ...
            $('#form-post-data').on('submit', function(event){
                ...
                console.log($(this).serialize())
                    $.ajax({
                        url:base_url+'/inventory/savedeliver',
                        method:'post',
                        data:formData,
                        dataType:'JSON',
                        contentType: false,
            ...
            function showSuccessMessage(message) {
                ...
                swal({title: "Success!", text: message, type: "success"},
                    function(){ 
                        window.location.href = base_url+'/inventory/deliver';
                    }
                );
            }
