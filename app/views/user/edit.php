                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control" value="<?= $data['user']['email']; ?>" placeholder="Email">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <select name="department" class="form-control" id="department">
                                                <option value="<?= $data['userdept']['id']; ?>"><?= $data['userdept']['department']; ?></option>
