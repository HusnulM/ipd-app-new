                        ...
                        for(var i=0; i<result.length; i++){
                            ...
                            html = `
                                <tr counter="`+ count +`" id="tr`+ count +`">
                                    ...
                                    <td> `+ result[i].material +`
                                        <input type="hidden" name="itm_material[]" counter="`+count+`" id="material`+count+`" class="form-control materialCode" style="width:120px;" required="true" value="`+ result[i].material +`" readonly />
                                    </td>
                                    <td> `+ result[i].matdesc +`
                                        <input type="hidden" name="itm_matdesc[]" counter="`+count+`" id="matdesc`+count+`" class="form-control" style="width:250px;" value="`+ result[i].matdesc +`" readonly/>
                                    </td>
                                    <td style="text-align:right;"> `+ formatNumber(selqty) +`
                                        <input type="hidden" name="itm_qty[]" counter="`+count+`" id="poqty`+count+`"  class="form-control inputNumber" style="width:100px; text-align:right;" required="true" value="`+ formatNumber(selqty) +`" readonly/>
                                    </td>
                                    <td> `+ result[i].unit +`
                                        <input type="hidden" name="itm_unit[]" counter="`+count+`" id="unit`+count+`" class="form-control" style="width:80px;" required="true" value="`+ result[i].unit +`" readonly/>
                                    </td>
                                    <td style="text-align:right;"> `+ formatNumber(result[i].price) +`
                                        <input type="hidden" name="itm_price[]" class="form-control disableInput inputNumber readOnly" style="width:100px;text-align: right;" counter="`+count+`" id="poprice`+count+`" required="true" value="`+ formatNumber(result[i].price) +`"/>
                                    </td>
                                    <td> `+ stringprnum +`
                                        <input type="hidden" name="prnum[]" counter="`+count+`" id="prnum`+count+`" class="form-control" style="width:130px;" readonly value="`+ stringprnum +`"/>
